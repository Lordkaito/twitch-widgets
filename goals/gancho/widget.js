...
function handleGrow(amount, callback, initial = false) {
  ...
  if (!completedGoal) {
    ...
    if (amountToUpdate >= mainObj.fieldData.firstStep) {
      items.peluche.src = "https://i.postimg.cc/RZ1Ykxsb/tannafurro.png";
    }

    if (amountToUpdate >= mainObj.fieldData.secondStep) {
      items.peluche.src = "https://i.postimg.cc/N0gnYCZG/tannamaid.png";
    }
    if (goalType === "tip") {
    ...
    items.peluche.src = "https://i.postimg.cc/NjvVCj4H/tannadiluc.png";
