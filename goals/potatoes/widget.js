...
const getApiData = async (obj) => {
  let data = await SE_API.store.get("beniartsPotatoesGoalWidgetPreviousGained");
  if (data === null) {
...
function updateApiData(amountToUpdate) {
  ...
  SE_API.store.set("beniartsPotatoesGoalWidgetPreviousGained", widgetApiData);
}

function clearApiData() {
  SE_API.store.set("beniartsPotatoesGoalWidgetPreviousGained", defaultApiData);
