...
const themes = {
  ...
  // pronounsText: " #cd9a75",
  campanitaRanaImg: "https://utfs.io/f/52b1a254-a98e-49c7-b64b-c75234f172cf-j496d2.png",
  firstMessageImg: "https://utfs.io/f/d6122376-6ae6-44e2-aae9-d2c325e2a0be-d37m1.png",
  vipImg: "https://utfs.io/f/fc47c12f-7523-4663-aeff-216ae190e5d4-1mjl0c.png",
  baseImg: "https://utfs.io/f/3ccc5382-70a8-48c7-8392-dce9ce99c885-klw162.png",
  modImg: "https://utfs.io/f/29052061-0f36-4640-9ff3-46e05f87bea5-1mjrjr.png",
  margaSub: "https://utfs.io/f/bde2fb09-4773-4d35-b839-e71a82569793-40rqtk.png",
}
...
class mainEvent {
  ...
  async createMainContainerElement() {
    ...
    superMainContainer.style.maxWidth = `${fieldData.maxTextWidth}rem`

    if (role.role === "streamer" || this.isSub) {
      const margarita = document.createElement("img")
      margarita.classList.add("flower-event")
      margarita.src = themes.margaSub
      mainContainer.appendChild(margarita)
    }

    mainContainer.style.background = fieldData.colorPickerMessageContainer
  ...
  async createPronounsContainer() {
    ...
    pronouns.innerText == "" ? (pronounsContainer.style.opacity = "0") : (pronounsContainer.style.opacity = "1")
  ...
  get roleImages() {
    ...
    if (firstMsg == 1) {
      roleImage.src = themes.firstMessageImg
    } else {
      ...
      switch (minPriorityRole.role) {
        case "streamer":
          roleImage.src = themes.baseImg
          break
        case "mod":
          console.log("mod")
          roleImage.src = themes.modImg
          break
        case "vip":
          roleImage.src = themes.vipImg
          break
        case "sub":
          roleImage.src = themes.baseImg
          break
  ...
  async createMainEventContainer() {
    ...
    mainContainer.style.maxWidth = `${fieldData.maxTextWidth}rem`
