...
class mainEvent {
  ...
  createCapitalizeUserElement() {
    ...
    capitalizeUser.innerText = "SuperLongUsername";
  ...
  async createPronounsContainer() {
    ...
    if (pronouns.innerText == "") pronouns.style.display = "none";
  ...
  async createMessageIconContainerElement() {
    ...
    const svgCheck = document.createElement("div");
    const svgCheck2 = document.createElement("div");
  ...
  >
    ...
    messageIconContainer.appendChild(svgCheck);
    messageIconContainer.appendChild(svgCheck2);
  ...
  async customEmotes() {
    ...
    let url; // do not remove this line
    let customEmotesArr;
    if (id != "") {
  ...
  async createMainEventContainer() {
    ...
    const eventTypeText = document.createElement("p");
    ...
    eventTypeText.classList.add("event-type-text");
    ...
    banana.src = "https://i.postimg.cc/jj2wpSKT/platano-event.png";

    separator.innerText = " | ";
    eventTypeText.innerText = eventDictionary[eventType];
    nameContainer.innerText = nameAndText;

    mainContainer.appendChild(banana);
    eventAndNameContainer.appendChild(nameContainer);
    fungiContainer.appendChild(eventTypeText);
    fungiContainer.appendChild(separator);
