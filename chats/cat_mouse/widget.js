...
class mainEvent {
  ...
  createRoleElement() {
    ...
    switch (role) {
      case "streamer":
        roleElement.classList.add("streamer-color");
        break;
      case "mod":
      ...
      case "sub":
        ...
        break;
      case "vip":
        roleElement.classList.add("vip-color");
        break;
      case "viewer":
        roleElement.classList.add("viewer-color");
        break;
    }
  ...
  get roleImages() {
    ...
    switch (minPriorityRole.role) {
      case "streamer":
        roleImage.src = `https://i.postimg.cc/rwwYm2QX/insstreamer.png`;
        break;
      case "mod":
        roleImage.src = `https://i.postimg.cc/GhQ5dmPx/insmod.png`;
        break;
      case "vip":
        roleImage.src = `https://i.postimg.cc/2S99L9Kq/insvip.png`;
        break;
      case "sub":
