...
class mainEvent {
  ...
  eventType(ev) {
    if (ev.type === "message") {
      return this.buildMessageCont(ev);
    }
  ...
  async createMainEventContainer() {
    ...
    let eventText = fieldData.eventText;
    let text = eventText != "" ? eventText : "Gracias por el follow!";
