...
class mainEvent {
  ...
  async createMainContainerElement() {
    ...
    superMainContainer.innerHTML = `
      ...
      ${
        isBot === true
          ? `<img src="${imagesUrls.bot}" class="role-img"/>`
        ...
        <div class="message-container">
          <div class="username-info-container">
            ...
            <div class="message-icon-container">
              <img class="trebol t1" src="${imagesUrls["trebol1"]}" alt="trebol1"/>
              <img class="trebol t2" src="${imagesUrls["trebol2"]}" alt="trebol1"/>
              <img class="trebol t3" src="${imagesUrls["trebol3"]}" alt="trebol1"/>
              <img class="trebol t4" src="${imagesUrls["trebol4"]}" alt="trebol1"/>
