...
class mainEvent {
  ...
  get cereza() {
    ...
    cereza.src = "https://i.postimg.cc/3xH620h3/Estrella.png";
  ...
  get roleImages() {
    ...
    imgCont.classList.add("role-img-cont");
    for (let i = 0; i < 3; i++) {
      let dot = document.createElement("div");
      dot.classList.add("dot");
      dot.classList.add(`dot-${i}`);
      imgCont.appendChild(dot);
    }
    imgCont.appendChild(roleImage);
  ...
  async createMainEventContainer() {
    ...
    for (let i = 0; i < 2; i++) {
      ...
      fungi.src = "https://i.postimg.cc/fLjmxtSx/Nube.png";
...
window.addEventListener("onEventReceived", async (obj) => {
  ...
  // this is to allow ONLY messages
  // if(listener !== "message") {
  //   return;
  // }

  // this is to allow ONLY messages and sub events
  // if(listener !== "subscriber-latest" && listener !== "message") {
  //   return;
  // }

  // if subs are enabled, this is mandatory
