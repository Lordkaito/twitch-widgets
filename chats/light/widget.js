...
class mainEvent {
  ...
  async createMainContainerElement() {
    ...
    brillo.src = "https://i.postimg.cc/tg81xTj0/strr.png";
  ...
  get roleImages() {
    ...
    switch (minPriorityRole.role) {
      case "streamer":
        ...
        break;
      case "mod":
        roleImage.src = `https://i.postimg.cc/52v5KwKK/gb.png`;
      ...
      case "vip":
        ...
        break;
      case "sub":
        roleImage.src = `https://i.postimg.cc/sgBHjQ65/az.png`;
  ...
  async createMainEventContainer() {
    ...
    moon.src = "https://i.postimg.cc/RhNK7fnR/llv.png";
    ...
    divImg.src = "https://i.postimg.cc/bJPm96zR/brii.png";
