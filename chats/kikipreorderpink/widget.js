...
class mainEvent {
  ...
  get roleImages() {
    ...
    switch (minPriorityRole.role) {
      case "streamer":
        roleImage.src = `https://i.postimg.cc/02f4ZD8k/streamer-rosa.png`;
        break;
      case "mod":
        roleImage.src = `https://i.postimg.cc/BnnVzb6x/mod-rosa.png`;
        break;
      case "vip":
        roleImage.src = `https://i.postimg.cc/KYKsZWtj/vip-rosa.png`;
        break;
      case "sub":
        roleImage.src = `https://i.postimg.cc/YCDsB7GT/sub-rosa.png`;
        break;
      case "viewer":
