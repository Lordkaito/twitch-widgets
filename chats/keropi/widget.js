...
class mainEvent {
  ...
  async createMainContainerElement() {
    ...
    const lazo = document.createElement("img");
    img.classList.add("left");
    img2.classList.add("right");
    lazo.classList.add("lazo");

    img.src = "https://i.postimg.cc/rmBfgKJG/pataizq.png";
    img2.src = "https://i.postimg.cc/59z7yS4s/pataderecha.png";
    lazo.src = "https://i.postimg.cc/L5jNW2Cc/kerolazo.png";
    ...
    mainContainer.appendChild(img2);
    mainContainer.appendChild(lazo);
  ...
  get roleImages() {
    ...
    switch (minPriorityRole.role) {
      case "streamer":
        roleImage.src = `https://i.postimg.cc/6QQbQsqZ/kerocorona.png`;
        break;
      case "mod":
        roleImage.src = `https://i.postimg.cc/Mp5rxZ6x/keroespada.png`;
        break;
      case "vip":
        roleImage.src = `https://i.postimg.cc/TwLkrrrY/keroestrella.png`;
        break;
      case "sub":
        roleImage.src = `https://i.postimg.cc/GpS78MT5/kerocorazon.png`;
        break;
      case "viewer":
