...
class mainEvent {
  ...
  get roleImages() {
    ...
    switch (minPriorityRole.role) {
      case "streamer":
        roleImage.src = `https://i.postimg.cc/RC85KcVj/streamer-ama.png`;
        break;
      case "mod":
        roleImage.src = `https://i.postimg.cc/7h5FjLXs/mod-ama.png`;
        break;
      case "vip":
        roleImage.src = `https://i.postimg.cc/02wgfbzr/vip-ama.png`;
        break;
      case "sub":
        roleImage.src = `https://i.postimg.cc/zv4sN1cJ/sub-ama.png`;
        break;
      case "viewer":
