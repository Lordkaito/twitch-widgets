...
class mainEvent {
  ...
  async createMainEventContainer() {
    ...
    spider.src = "https://i.postimg.cc/zvVRc6Mw/ara-a.png";
    const line = document.createElement("div");
    ...
    switch (eventType) {
      case "follower":
        band.src = "https://i.postimg.cc/1RjFqRnv/bandera-fol.png";
        break;
      case "subscriber":
        band.src = "https://i.postimg.cc/HkG76St5/bandera-sub.png";
        break;
      case "cheer":
        band.src = "https://i.postimg.cc/FRPLGNPs/bandera-cheer.png";
        break;
      case "tip":
        band.src = "https://i.postimg.cc/TY5Dq8nf/bandera-tip.png";
        break;
      case "raid":
        band.src = "https://i.postimg.cc/T1FWMQMz/bandera-raid.png";
        break;
    }
