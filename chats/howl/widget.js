...
class mainEvent {
  ...
  async createMainContainerElement() {
    ...
    flowers.src = "https://i.postimg.cc/1ttzBhbT/campanitas.png";
  ...
  get roleImages() {
    ...
    switch (minPriorityRole.role) {
      case "streamer":
        roleImage.src = `https://i.postimg.cc/zD4ny0g5/how4.png`;
        break;
      case "mod":
        roleImage.src = `https://i.postimg.cc/ydb8rpHN/how2.png`;
        break;
      case "vip":
        roleImage.src = `https://i.postimg.cc/Z0kKJ90t/how3.png`;
        break;
      case "sub":
        roleImage.src = `https://i.postimg.cc/hvQtF8D1/how1.png`;
        break;
      case "viewer":
