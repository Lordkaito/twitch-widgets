...
let imagesUrls = {
  mod: "https://i.ibb.co/dgxkYRd/mod-hada.png",
  vip: "https://i.ibb.co/v1NWHBx/vip-hada.png",
  subscriber: "https://i.ibb.co/Y4sgfvJ/sub-hada.png",
  viewer: "https://i.ibb.co/rp3tBqQ/viewer-hada.png",
  streamer: "https://i.ibb.co/V3r6R7b/streamer-hada.png",
...
class mainEvent {
  ...
  async createMainContainerElement() {
    ...
    superMainContainer.innerHTML = `
      ...
      <img class="alas ala-izq" src="https://i.ibb.co/L6FNPbN/alahada.png" />
      <img class="alas ala-der" src="https://i.ibb.co/L6FNPbN/alahada.png" />
      <img class="alas-puntos alas-puntos-izq" src="https://i.ibb.co/2sxgkKT/brillohada.png" />
      <img class="alas-puntos alas-puntos-der" src="https://i.ibb.co/2sxgkKT/brillohada.png" />
        <div class="message-container">
          <div class="username-info-container" style="background-color:${
            ...
            <div class="username-info">
              ...
              <img class="dot" src="https://i.ibb.co/SRPq5hd/corazonhada.png"></img>
