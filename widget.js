...
class Message {
  ...
  async createMainContainerElement() {
    ...
    mainContainer.style.borderColor = this.isStreamer
      ? this.themeColor().streamer.border
      : this.themeColor().border;
  ...
  async createUsernameInfoElement() {
    ...
    usernameInfo.style.backgroundColor = this.isStreamer
      ? this.themeColor().streamer.userBackg
      : this.themeColor().userBckg;
  ...
  async createPronounsContainer() {
    ...
    pronouns.style.backgroundColor = this.isStreamer
      ? this.themeColor().streamer.pronsBackg
      : this.themeColor().pronsBackg;
  ...
  async buildMessage() {
    ...
    textContainer.style.color = this.isStreamer
      ? this.themeColor().streamer.color
      : this.themeColor().messageText;
